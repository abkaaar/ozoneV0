...
export function FAQSection() {
  return (
    <section className="w-full px-16 py-12 flex flex-col md:flex-row gap-4 justify-between">
      <div className="mb-10">
        <h2 className="text-5xl font-medium mb-4">Frequently Asked Questions</h2>
...
<div>
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-7" className="border-t border-b py-4">
          ...
          <AccordionContent className="text-base">Steps to begin your investment journey with us.</AccordionContent>
        </AccordionItem>
      </Accordion>
</div>
